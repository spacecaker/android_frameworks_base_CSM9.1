 ...
 */
public class NoteWaveView extends View {
    private static final String TAG = "NoteWaveView";
    ...
    public NoteWaveView(Context context) {
        this(context, null);
    }

    public NoteWaveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        Resources res = context.getResources();

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.NoteWaveView);
        mOuterRadius = a.getDimension(R.styleable.NoteWaveView_noteouterRadius, mOuterRadius);
        mHorizontalOffset = a.getDimension(R.styleable.NoteWaveView_notehorizontalOffset,
                mHorizontalOffset);
        mVerticalOffset = a.getDimension(R.styleable.NoteWaveView_noteverticalOffset,
                mVerticalOffset);
        mHitRadius = a.getDimension(R.styleable.NoteWaveView_notehitRadius, mHitRadius);
        mSnapMargin = a.getDimension(R.styleable.NoteWaveView_notesnapMargin, mSnapMargin);
        mVibrationDuration = a.getInt(R.styleable.NoteWaveView_notevibrationDuration,
                mVibrationDuration);
        mFeedbackCount = a.getInt(R.styleable.NoteWaveView_notefeedbackCount,
                mFeedbackCount);
        mHandleDrawable = new TargetDrawable(res,
                a.getDrawable(R.styleable.NoteWaveView_notehandleDrawable));
        mTapRadius = mHandleDrawable.getWidth()/2;
        mOuterRing = new TargetDrawable(res, a.getDrawable(R.styleable.NoteWaveView_notewaveDrawable));

        // Read chevron animation drawables
        final int chevrons[] = { R.styleable.NoteWaveView_leftnoteChevronDrawable,
                R.styleable.NoteWaveView_rightnoteChevronDrawable,
                R.styleable.NoteWaveView_topnoteChevronDrawable,
                R.styleable.NoteWaveView_bottomnoteChevronDrawable
        };
    ...
    private void handleMove(MotionEvent event) {
        ...
        for (int k = 0; k < historySize + 1; k++) {
            ...
            if (activeTarget != -1) {
				...
				mOuterRing.setState(TargetDrawable.STATE_ACTIVE);
